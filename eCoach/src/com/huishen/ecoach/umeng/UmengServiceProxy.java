...
//					mPushAgent.getTagManager().add(getPushTag());
					...
					Log.w(LOG_TAG, "Warning: fail to add push tag and/or alias."+e.getMessage());
					e.printStackTrace();
				}
			}
		});
	...
	private static final void sendDeviceRegisterBroadcast(Context context, String deviceToken){
